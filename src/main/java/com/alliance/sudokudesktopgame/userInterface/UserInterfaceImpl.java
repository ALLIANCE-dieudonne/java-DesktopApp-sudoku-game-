...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
  ...
  private void drawTextFields(Group root) {
    ...
    for (int xIndex = 0; xIndex < 9; xIndex++) {
      for (int yIndex = 0; yIndex < 9; yIndex++) {
        ...
        textFieldHashCoordinates.put(new Coordinates(xIndex, yIndex), tile);
  ...
  public void updateSquare(int x, int y, int input) {
    SudokuTextField tile = textFieldHashCoordinates.get(new Coordinates(x, y));
  ...
  public void updateBoard(SudokuGame game) {
    for (int xIndex = 0; xIndex < 9; xIndex++) {
      for (int yIndex = 0; yIndex < 9; yIndex++) {
        TextField tile = textFieldHashCoordinates.get(new Coordinates(xIndex, yIndex));
